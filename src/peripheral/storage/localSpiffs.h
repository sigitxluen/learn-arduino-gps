...
class localSpiffs : public storageInterface {
  ...
  public:
    void init ();
    void get_device_config (const char* path);
    void get_interval_data (const char* path);
    void get_heavy_data (const char* path);
    void set_outbox_data (const char* path);
    void get_outbox_data (const char* path);
